...
def extract(pages):
    ...
    def is_safe_fallback_field_label(txt: str) -> bool:
    ...
    current_schedule = ""
    current_activity = ""
    last_field_by_form: Dict[str, str] = {}
    ...
    for page_idx0, lines in pages:
        ...
        for am in answers_markers:
            ...
            context_is_activity = False
            if local_act is not None:
                context_is_activity = True
            elif current_activity and form_name == norm_space(current_activity):
                context_is_activity = True
            ...
            if anchor is not None:
                ...
                prev = last_field_by_form.get(form_name or "")
                if prev and is_safe_fallback_field_label(prev):
                    field_name = prev
                elif context_is_activity and is_safe_fallback_field_label(form_name):
            ...
            if field_name:
                ...
                if form_name and field_name:
                    last_field_by_form[form_name] = field_name
