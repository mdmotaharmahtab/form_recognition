...
1. **Section headers being extracted as fields**: Lines like "Admission Restrictions: Photo ID #1" are section headers, not field labels
2. **Missing fields**: Some actual questions are being skipped
3. **Multi-part questions**: Lines that continue questions (like "participant's wrist?" on page 1) are being treated as separate fields

Let me analyze the pattern:
- Section headers end with `#1`, `#2`, etc. and precede the actual questions
- Actual field labels are the questions that follow these headers
- Some questions wrap across multiple lines and need to be joined
