I'll analyze the issues and extend the program to fix them while maintaining existing coverage.

The main problems are:
1. **Cluster 0 (50% covered)**: Pages like 497, 795 have form titles and possibly field labels not being extracted
2. **Cluster 6 (0% covered)**: Table of contents pages with blue links - these are form titles, not fields
3. **Cluster 8 (0% covered)**: Pages with "Repeatable row" instructions - no actual fields to extract
4. **False positives**: Extracting text that's not field labels (answer options, instructions, rating scale text)

Key fixes needed:
- Better detection of answer options vs field labels
- Better detection of instructional text
- Handle pages with minimal content (form title only)
- Don't extract from TOC pages listing form names
