...
1. **Page 7 (Change History table)**: Stop extracting table cells - detect tabular layouts with multiple short items in aligned rows
2. **Page 40 & 171**: Handle barcode/sample collection tables better - extract actual field labels, skip table data
3. **Pages 71, 136**: Stop extracting long instruction paragraphs and table structure text
4. **Page 440**: Extract "Time Placed in Position", avoid partial sentence fragments
5. **Pages 4, 6 (clusters 9-11)**: Handle TOC-like pages with colored links
