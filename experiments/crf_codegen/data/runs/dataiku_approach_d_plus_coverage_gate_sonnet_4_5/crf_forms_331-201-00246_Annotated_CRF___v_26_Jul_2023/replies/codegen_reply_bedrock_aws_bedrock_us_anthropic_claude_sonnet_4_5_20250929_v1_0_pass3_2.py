Looking at the sample pages from cluster 2, I can see they contain data-entry fields that my program is missing:

- "Intensity of Ideation" (column header/field label)
- "Since Last Visit" (column header/field label)

These appear to be table column headers that represent data-entry fields. The pages show a sparse layout with column headers and some red text annotations. My current program is likely skipping these because they appear as isolated short phrases or because the table structure isn't being recognized properly.

Here's the updated program that handles these table-based layouts:
