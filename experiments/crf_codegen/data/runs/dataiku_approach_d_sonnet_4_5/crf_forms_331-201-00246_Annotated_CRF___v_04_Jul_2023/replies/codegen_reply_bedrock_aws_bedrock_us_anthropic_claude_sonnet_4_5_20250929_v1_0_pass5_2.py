Looking at the sample pages, I can see they contain a data-entry field that my program is currently missing.

The pages show:
1. An instructional line: "If the subject did not meet eligibility criteria, please specify criterion number below."
2. A list of checkboxes with codes: INCL1, INCL2, INCL3, INCL4, INCL5, INCL6, EXCL1, EXCL2, etc.

This is an eligibility criteria checklist where users select which criterion was not met. The field label is the instructional text, and the INCL/EXCL codes are the answer options (checkboxes).

My current program skips these because:
1. It filters out the instructional text starting with "If the subject did not meet"
2. It filters out standalone INCL/EXCL codes

This is a legitimate data-entry field that should be extracted. Here's the updated program:
