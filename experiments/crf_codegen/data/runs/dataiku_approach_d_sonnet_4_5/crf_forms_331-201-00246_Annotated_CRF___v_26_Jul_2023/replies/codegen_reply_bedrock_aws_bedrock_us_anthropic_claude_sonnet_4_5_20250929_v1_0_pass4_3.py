...
def extract(pages):
    ...
    for page_idx, lines in pages:
        ...
        while i < len(lines):
            ...
            if "Change History" in current_form and line.y0 > 250 and line.size < 10:
                # Skip short data fragments typical of table cells
            ...
            if line.y0 >= 100 and line.y0 <= 200 and line.size >= 9 and not line.non_black:
                # Skip if this is a change history header
