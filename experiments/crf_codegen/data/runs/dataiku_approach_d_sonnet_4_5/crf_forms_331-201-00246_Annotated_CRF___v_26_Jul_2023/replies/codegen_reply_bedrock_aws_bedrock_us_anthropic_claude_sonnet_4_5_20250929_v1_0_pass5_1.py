...
# - Family A: Table of contents / index page with blue hyperlinks
# - Family B: Continuation of table of contents
# - Family C: Eligibility criteria checklist with codes (INCL1-6, EXCL1-16)
# The main field-bearing pages appear in title-context samples with form titles
# in large blue font (~16.5pt #004c99) and field labels in black ~9pt.
# Strategy: Identify form titles by size/color, extract field labels that follow,
# skip machine codes in red/gray and table headers/furniture.
...
def extract(pages):
    ...
    for page_idx, lines in pages:
        ...
        while i < len(lines):
            ...
            # Skip codes like INCL1, EXCL1, etc. (standalone)
