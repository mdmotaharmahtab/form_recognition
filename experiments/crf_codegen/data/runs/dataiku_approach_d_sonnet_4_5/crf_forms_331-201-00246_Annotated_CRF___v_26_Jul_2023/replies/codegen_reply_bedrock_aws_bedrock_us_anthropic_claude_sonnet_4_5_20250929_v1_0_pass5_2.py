Looking at the sample pages, I can see they contain a data-entry field that my program is missing:

**Page 201 and 307 both show:**
- An instructional text: "If the subject did not meet eligibility criteria, please specify criterion number below."
- A list of checkboxes for INCL1-6 and EXCL1-16 (these are answer options, not field labels)

This is actually a **single data-entry field** where the user selects which eligibility criterion was not met. The field label is the instructional text, and INCL1-EXCL16 are the answer options (which should not be extracted per the task requirements).

My current program skips this because:
1. It filters out text containing words like "subject" 
2. It requires a machine code to follow the field label

I need to update the program to capture this field label while still excluding the answer option codes.
