...
def extract(pages):
    ...
    for page_idx, lines in pages:
        ...
        # These have numbered items (e.g., "17. I felt...") at x ~64
        ...
        for line in lines:
            if line.x0 > 500 and line.size >= 6.0:
                ...
                if text and not text.isdigit():
                    # Check if there's a corresponding number at x ~44-47 on same y
                    has_number = False
                    for other_line in lines:
                        if 40 < other_line.x0 < 50 and abs(other_line.y0 - line.y0) < 5:
