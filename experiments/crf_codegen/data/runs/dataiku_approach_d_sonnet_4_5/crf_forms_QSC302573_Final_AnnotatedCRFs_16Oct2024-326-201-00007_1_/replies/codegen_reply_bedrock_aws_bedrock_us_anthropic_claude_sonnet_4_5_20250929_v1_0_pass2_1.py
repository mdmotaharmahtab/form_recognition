...
# - A "Schedule Category & Name" line near the top provides the form/section name
# - Activities are introduced by bold text at x~167.7 with "Activity" column header
# - Field questions appear as bold text at x~167.7, often spanning multiple lines
# - Answer options (starting with "O") and SAS codes are NOT fields
# - We extract the question text, joining wrapped lines, and use the Schedule name as form_name
