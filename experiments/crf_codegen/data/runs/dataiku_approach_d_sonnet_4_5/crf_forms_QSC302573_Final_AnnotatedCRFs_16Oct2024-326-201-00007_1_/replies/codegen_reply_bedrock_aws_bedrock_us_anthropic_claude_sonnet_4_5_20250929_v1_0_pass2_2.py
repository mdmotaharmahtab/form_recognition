...
def extract(pages):
    ...
    for page_idx, lines in pages:
        ...
        # Look for "Comment:" field - it appears at x~29.9 in blue/bold
        # This is a data-entry field that appears on many pages
        for i, line in enumerate(lines):
            if line.text == "Comment:" and line.bold and line.x0 < 50:
