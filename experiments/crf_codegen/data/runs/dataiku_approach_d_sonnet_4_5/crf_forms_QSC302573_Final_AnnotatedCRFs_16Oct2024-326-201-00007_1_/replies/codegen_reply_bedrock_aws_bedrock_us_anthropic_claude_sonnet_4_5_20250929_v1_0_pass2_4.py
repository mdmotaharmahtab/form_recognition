...
def extract(pages):
    ...
    for page_idx, lines in pages:
        ...
        # Look for "Comment:" field - it appears at x~29.9 as a blue bold label
        # This is a data field, not page furniture (it's in the content area below activities)
        for i, line in enumerate(lines):
            if (line.text == "Comment:" and 
                line.bold and 
                line.x0 < 50 and  # Left side of page
                line.color == "#4682b4"):  # Blue color indicates it's a field label
