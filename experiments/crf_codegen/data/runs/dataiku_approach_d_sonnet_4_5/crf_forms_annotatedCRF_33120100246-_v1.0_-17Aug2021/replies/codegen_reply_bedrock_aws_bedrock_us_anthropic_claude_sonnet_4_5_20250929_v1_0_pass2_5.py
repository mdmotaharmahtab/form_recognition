...
1. **Page 84 & 146**: Extract numbered criteria fields (`\1.\`, `\2.\`, etc.) that are currently being skipped as "prose"
2. **Page 427**: Extract "If Yes, describe" and avoid extracting prose fragments
3. Avoid extracting partial sentences that are clearly prose fragments

The main problems are:
- My prose detection is too aggressive and skipping legitimate numbered criteria fields
- I'm extracting sentence fragments from long prose paragraphs
- Need better detection of when numbered items are actual fields vs. prose list items
