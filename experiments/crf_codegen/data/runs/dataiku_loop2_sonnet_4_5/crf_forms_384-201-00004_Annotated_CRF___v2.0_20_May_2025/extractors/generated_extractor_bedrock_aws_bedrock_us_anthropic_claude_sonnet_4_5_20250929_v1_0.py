...
# EXTENSION: Some fields may have labels at slightly different x positions (e.g., x~60-80).
# Check for fields that have checkboxes/inputs on the same line or nearby lines.
...
def extract(pages):
    ...
    for page_idx, lines in pages:
        ...
        while i < len(lines):
            ...
            # Look for field labels: x between 40-90 (expanded range), size 7-11, not too high on page
            if (40 <= line.x0 <= 90 and 7 <= line.size <= 11 and 
