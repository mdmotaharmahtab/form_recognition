...
1. **Page 4, 6 (cluster 5)**: These are TOC pages with numbered blue entries like "3.137. Urine Drug Screen" - currently skipped, but they ARE genuine form titles that should be extracted
2. **Page 211**: Missing field "If not collected, reason:" - need to be more permissive for certain field patterns
3. **Page 17**: False positives like "Unscheduled Visits Visit Label" - need better structural filtering for table headers
4. **Page 276**: Wrong form attribution - need to improve form title persistence logic
5. **Clusters 4, 6, 9**: Low coverage on some page types
