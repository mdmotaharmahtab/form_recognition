Looking at the problems, I need to fix several issues:

1. **Page 84, 86, 147, 87**: Missing escaped numbered criteria like `\1.\`, `\2.\`, etc. - these are being extracted but then filtered out by position/structural rules
2. **Pages 47, 48, 52, 241**: Missing "Chemistry/Hematology clinically significant abnormal assay #N:" fields - these appear to be right-positioned dropdown labels that need better detection
3. **Page 427**: False positives "If Yes, describe" - need to filter these out as they're likely answer prompts, not field labels
4. **Pages 125, 307**: "Result of Repeat Test" fields in poorly-covered cluster 2

Let me rewrite the program to address these issues:
