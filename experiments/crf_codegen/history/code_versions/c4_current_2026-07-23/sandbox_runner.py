...
# unicodedata/string matter for non-Latin documents; typing/dataclasses/enum
# are declaration-only conveniences models reach for reflexively (a NameError
# on `from typing import List` costs a whole revision cycle for zero safety
# gain); datetime is pure value arithmetic. Nothing here reaches IO.
import bisect
import collections
import dataclasses
import datetime
...
_ALLOWED_MODULES = {m.__name__: m for m in (
    ...
    statistics, json, typing, dataclasses, enum, datetime)}
