...
from codegen import run_extractor
...
def main() -> None:
    ...
    for pdf_path in list_root_pdfs():
        ...
        for src_path in sorted(glob.glob(os.path.join(outdir, "generated_extractor_*.py"))):
            ...
            if "_pass" in tag:
                ...
                continue
            csv_path = os.path.join(outdir, f"fields_codegen_{tag}.csv")
