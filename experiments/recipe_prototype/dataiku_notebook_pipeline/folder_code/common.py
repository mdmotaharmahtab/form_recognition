...
# repo root = three levels above this file (ECS/experiments/recipe_prototype/
# scripts/); ECS_BASE env var overrides (the Dataiku notebook always sets it,
# so these repo-relative defaults only matter for local runs)
