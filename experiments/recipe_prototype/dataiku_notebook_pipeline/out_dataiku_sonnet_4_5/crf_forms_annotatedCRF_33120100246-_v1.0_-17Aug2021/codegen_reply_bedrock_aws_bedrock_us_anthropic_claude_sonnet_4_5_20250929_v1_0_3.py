...
def extract(pages):
    ...
    for page_idx, lines in pages:
        ...
        while i < len(lines):
            ...
            # Expanded list to catch more answer options
            answer_options = [
            ...
            if line.non_black and text in answer_options:
                i += 1
                continue
            ...
            if line.size >= 7.0 and line.size <= 10.0:
                ...
                if has_marker:
                    ...
                    skip_patterns = [
                        ...
                        r'^\d+\.\d+\.',  # TOC entries
                        r'.*\(optional\)$',  # Optional comments
                        r'.*Comments.*\(optional\).*',  # Comments fields marked optional
                        r'.*decision\).*',  # Decision text with parentheses
                    ]
