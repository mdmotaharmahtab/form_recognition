...
from common import CRF_DIR, OUT_DIR, build_page_lines, doc_key, list_root_pdfs
from generic_profile import page_profile, token_weights, weighted_jaccard
...
def main() -> None:
    ...
    for pdf in list_root_pdfs():
        ...
        cpath = os.path.join(outdir, "clusters.json")
